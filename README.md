...
숫자로 증명하는 개선 — 파일 업로드 **24.5% 단축**, 이미지 전송 **97% 단축**, 모델 성능 **0.87 → 0.99**
...
- 🖼️ 이미지 1,000장 전송 — 반복 API 호출을 ZIP 압축 전송으로 개선, **17분 → 30초 (97% ↓)**, 외부 업체와 서버 측 변경 직접 조율
